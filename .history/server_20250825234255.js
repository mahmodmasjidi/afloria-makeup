...
// MongoDB Bağlantısı
// -------------------------
const MONGO_URI = process.env.MONGO_URI || "const MONGO_URI = process.env.MONGO_URI || "mongodb+srv://maama:Alam4321@products.7svhkvw.mongodb.net/?retryWrites=true&w=majority";
";
